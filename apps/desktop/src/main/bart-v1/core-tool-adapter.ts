...
export function createBartToolBindings(
  ...
  return [
    ...
    tool('thread_fork',
      'Fork an idle Agent Thread at its current conversation and send the supplied prompt to the new Thread. Returns the new threadId and executionId after dispatch.',
