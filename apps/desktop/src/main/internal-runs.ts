    ...
    messages: [
      {
        ...
        content: [
          ...
          'Choose 1-3 concise, stable, discriminative task tags ordered by relevance.',
          'Each tag must add a distinct filtering signal. Prefer a concrete technology, component, domain, workflow, or deliverable.',
