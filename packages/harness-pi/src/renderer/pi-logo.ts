 ...
 * The official project README uses this URL for the Pi logo:
 * https://github.com/earendil-works/pi/blob/main/README.md
 */
const piLogoSvg = `<?xml version="1.0" encoding="UTF-8"?>
...
/** The single inline logo source shared by every Pi Renderer surface. */
export const piLogo = `data:image/svg+xml,${encodeURIComponent(piLogoSvg)}`
